...
class WeekPromotionScreen extends StatelessWidget {
  ...
  const WeekPromotionScreen({Key key, this.discountGuide}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Directionality(
        ...
        child: ChangeNotifierProvider(
          create: (context) => WeekPromotionData(discountGuide),
          child: Scaffold(
              appBar: AppBar(
                centerTitle: true,
              ...
              backgroundColor: Colors.white,
              body: WeekPromotionBody()),
        ));
  }
}

class WeekPromotionBody extends StatelessWidget {
  @override
  Widget build(BuildContext context) {

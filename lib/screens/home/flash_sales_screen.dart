...
import 'package:mawared_app/screens/home/week_promotion_data.dart';
import 'package:provider/provider.dart';
import 'package:shimmer/shimmer.dart';

class FlashSaleScreen extends StatelessWidget {
  final String discountGuide;

  const FlashSaleScreen({Key key, this.discountGuide}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Directionality(
        ...
        child: ChangeNotifierProvider(
          create: (context) =>
              WeekPromotionData('0b295202-f8ce-4a84-b591-09c1b0188ef1'),
          child: Scaffold(
              appBar: AppBar(
                centerTitle: true,
...
class FlasSalesBody extends StatefulWidget {
  @override
  _FlasSalesBodyState createState() => _FlasSalesBodyState();
}

class _FlasSalesBodyState extends State<FlasSalesBody> {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            ///
            ///
            Provider.of<WeekPromotionData>(context).showLoading
                    ...
                    children: [
                      Container(
                        ...
                        child: CachedNetworkImage(
                          fit: BoxFit.cover,
                          imageUrl: Provider.of<WeekPromotionData>(context)
                                  .weekPromotion
                                  .discountImgurl ??
                              '',
                      ...
                      Text(
                        ' ينتهي في :${countdownController.currentRemainingTime.days}:${countdownController.currentRemainingTime.hours}:${countdownController.currentRemainingTime.min}:${countdownController.currentRemainingTime.sec}',
                        style: TextStyle(
                          fontSize: 17.0,
                          letterSpacing: 2.0,
                      ...
                      GridView.count(
                        ...
                        children: List.generate(
                          ...
                          Provider.of<WeekPromotionData>(context)
                              .weekPromotion
                              .discountproducts
                              .length,
                          (index) => ItemGrid(

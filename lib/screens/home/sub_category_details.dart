...
class SubCategoryDetailsScreen extends StatelessWidget {
  ...
  const SubCategoryDetailsScreen({Key key, this.guide, this.name})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Directionality(
        ...
        child: ChangeNotifierProvider(
          create: (context) => SubCategoryData(guide),
          child: Scaffold(
              appBar: AppBar(
                centerTitle: true,
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            ///
            ///
            Provider.of<SubCategoryData>(context).showLoading
                ...
                : GridView.count(
                    ...
                    children: List.generate(
                      ...
                      Provider.of<SubCategoryData>(context)
                          .categoryDetails
                          .category
                          .products
                          .length,
                      (index) => ItemGrid(Provider.of<SubCategoryData>(context)
                          .categoryDetails
                          .category
                          .products[index]),
                    ),

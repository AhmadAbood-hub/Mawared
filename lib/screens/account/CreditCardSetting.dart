              ...
              children: <Widget>[
                Padding(
                  ...
                  child: Stack(
                    children: <Widget>[
                      Image.asset(
                        "assets/images/creditCardVisa.png",
                        height: 220.0,
                        fit: BoxFit.fill,
                      ),
                      Column(
                ...
                Padding(
                  padding: const EdgeInsets.only(
                      top: 30.0, right: 15.0, bottom: 10.0),
                  child: Text(
                    "معلومات التحويلات",
      ...
      child: Container(
        ...
        child: Column(
          children: <Widget>[
            Padding(
              padding:
                  const EdgeInsets.only(top: 20.0, right: 20.0, left: 60.0),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: <Widget>[
                  Text(
            ...
            Padding(
              padding: const EdgeInsets.only(
                  top: 20.0, bottom: 5.0, right: 20.0, left: 60.0),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: <Widget>[
                  Column(
